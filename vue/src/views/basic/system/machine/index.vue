<template>
  <div>
    <!-- 系统信息 -->
    <a-row :gutter="24">
      <a-col :md="12" :sm="24" style="padding-left: 12px; padding-right: 0px">
        <Card :loading="loading" title="系统信息" :bordered="false">
      ...
      <a-col :md="12" :sm="24" style="padding-left: 0px; padding-right: 12px">
        <Card :loading="loading" title="网络信息" :bordered="false">
          <table class="sysInfo_table">
            <tr>
    ...
    <Card :loading="loading" title="其他信息" :bordered="false">
      <table class="sysInfo_table">
        <tr>
...
<script>
  import { sysMachineBase, sysMachineUse, sysMachineNetwork } from '/@/api/saas/machineManage';
  export default {
    data() {
      return {
        loading: true,
