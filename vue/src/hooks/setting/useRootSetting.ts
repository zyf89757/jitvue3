...
export function useRootSetting() {
  ...
  const getAppSizeBool = computed(() => appStore.getProjectConfig.appSize == 'small');

  const getPermissionCacheType = computed(() => appStore.getProjectConfig.permissionCacheType);
