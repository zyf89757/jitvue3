...
<script type="text/babel">
  ...
  import { resetSize } from '/@/components/VerifyPro/utils/util';
  import { aesEncrypt } from '/@/components/VerifyPro/utils/ase';
  import { captchaGet, captchaCheck } from '/@/api/sys/captcha';
  import {
    computed,
    onMounted,
    reactive,
    ...
    setup(props) {
      ...
      function move(e) {
        ...
        if (status.value && isEnd.value == false) {
          ...
          if (
            move_block_left >=
            barArea.value.offsetWidth - parseInt(parseInt(blockSize.width) / 2) - 2
          ) {
            move_block_left =
              barArea.value.offsetWidth - parseInt(parseInt(blockSize.width) / 2) - 2;
          }
