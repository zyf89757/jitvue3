  ...
  export default defineComponent({
    ...
    setup(props, { slots }) {
      ...
      const getComponentsProps = computed(() => {
        ...
        //   formModel[field] = formModel[field].toString();
        // }
      ...
      function onkeyup(e: any) {
        ...
        //       if (tempList[i + 1]) {
        //         if (isVisible(tempList[i + 1]) && !tempList[i + 1].hasAttribute('disabled')) {
        //           tempList[i + 1].focus();
        //         } else {
        //           tempList[i + 2].focus();
        //         }
      ...
      function renderComponent() {
        ...
        const propsData: Recordable = {
          // 允许设置清理
          allowClear: unref(getComponentsProps)?.allowClear
            ? unref(getComponentsProps)?.allowClear
            : true,
